...
// Static route that uses query parameters instead of dynamic routes
// Usage: /users/details?id=user_123
...
const SingleUserPageContent = () => {
  ...
  if (!id) {
    return <div className="">No user ID provided!</div>;
  }
